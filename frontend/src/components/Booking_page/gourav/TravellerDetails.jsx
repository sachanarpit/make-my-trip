        ...
        <div>
            ...
            <div className="outer_div">
                ...
                <div className="inner_shadow_box">
                    ...
                    <span style={{marginLeft:"15px"}}><b>ADULT 1</b></span>
                    <div className="line"></div>
                    <p> <b>IMPORTANT: </b> Enter your name as it is mentioned on your passport or any government approved ID</p>
                    <input className="name_inp" type="text" placeholder="First & Middle Name" />
                ...
                <div className="line"></div>
                <div style={{color:"#1f77f7"}}> <b> + ADD ADULT</b></div>
            </div>
        </div>
    )
}
